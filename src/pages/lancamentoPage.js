...
const LancamentosPage = () => {
  ...
  const fetchProdutos = async () => {
    try {
      ...
      const novosProdutos = data.filter(produto => produto.is_newArrivals);
  ...
  return (
    <>
      ...
      <main className="lancamentoPagecontainer">
        <section className="lancamentoPageSection">
          <h1>Lançamentos</h1>
          <div className="lancamentoPageGride">
